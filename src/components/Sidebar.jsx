...
const Sidebar = () => {
  ...
  // Using lucide-react with adjusted strokeWidth for "Bold" look similar to IG
  ...
  const menuItems = [
    {
      ...
      label: "Home",
    }, // Filled home isn't standard in Lucide, using stroke for now or fill if supported? Lucide icons are strokes. I will use strokeWidth 3 for boldness.
    {
      icon: (
        <svg
          fill="currentColor"
    ...
    },
    {
      icon: (
        <img
          src="https://ui-avatars.com/api/?name=User&background=random&rounded=true"
          alt="Profile"
  ...
  return (
    <div className="fixed left-0 top-0 h-full max-w-[335px] w-full border-r border-gray-300 dark:border-[#383838] bg-white dark:bg-black px-3 py-5 hidden md:flex flex-col z-50 transition-colors duration-300">
      <div className="mb-5 px-3 pt-6 text-black dark:text-white">
        <svg
          fill="currentColor"
          height="29"
          role="img"
      ...
      <div className="mt-auto pb-8 relative">
        {isMoreMenuOpen && (
          <div
            ref={menuRef}
            className="absolute bottom-full left-0 w-[266px] bg-white dark:bg-[#262626] rounded-xl shadow-[0_4px_12px_rgba(0,0,0,0.15)] dark:shadow-xl overflow-hidden mb-4 p-2 ring-1 ring-black/5 dark:ring-0"
          >
            {showAppearanceMenu ? (
