...
const Sidebar = () => {
  ...
  return (
    <>
      <div
        className={`fixed left-0 top-0 h-full border-r border-gray-300 dark:border-[#383838] bg-white dark:bg-black px-3 py-5 hidden md:flex flex-col z-50 transition-transform duration-300 w-[335px] overflow-hidden`}
        style={{
